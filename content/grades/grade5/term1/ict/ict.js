// ملف JavaScript خاص بمادة ict - grade5 - term1
  ...
  const lessons = [
    {
      ...
      type: 'pdf',
      url: 'https://example.com/grade5/term1/ict/lesson1.pdf'
    },
    {
      title: 'الدرس الثاني',
      description: 'الأجزاء الأساسية',
      type: 'text',
      url: 'https://example.com/grade5/term1/ict/lesson2.txt'
    },
    {
      title: 'الدرس الثالث',
      description: 'تطبيقات عملية',
      type: 'pdf',
      url: 'https://example.com/grade5/term1/ict/lesson3.pdf'
    }
  ];
  container.innerHTML='';
  ...
  const games = [
    {
      ...
      type: 'html',
      url: 'https://example.com/grade5/term1/ict/game1.html'
    },
    {
      title: 'لعبة التطبيق',
      description: 'تطبيق عملي للمفاهيم',
      type: 'html',
      url: 'https://example.com/grade5/term1/ict/game2.html'
    }
  ];
  container.innerHTML='';
