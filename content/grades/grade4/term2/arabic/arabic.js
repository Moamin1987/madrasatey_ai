// ملف JavaScript خاص بمادة arabic - grade4 - term2
  ...
  const lessons = [
    {
      ...
      type: 'pdf',
      url: 'https://example.com/grade4/term2/arabic/lesson1.pdf'
    },
    {
      title: 'الدرس الثاني',
      description: 'الأجزاء الأساسية',
      type: 'text',
      url: 'https://example.com/grade4/term2/arabic/lesson2.txt'
    },
    {
      title: 'الدرس الثالث',
      description: 'تطبيقات عملية',
      type: 'pdf',
      url: 'https://example.com/grade4/term2/arabic/lesson3.pdf'
    }
  ];
  container.innerHTML='';
  ...
  const games = [
    {
      ...
      type: 'html',
      url: 'https://example.com/grade4/term2/arabic/game1.html'
    },
    {
      title: 'لعبة التطبيق',
      description: 'تطبيق عملي للمفاهيم',
      type: 'html',
      url: 'https://example.com/grade4/term2/arabic/game2.html'
    }
  ];
  container.innerHTML='';
