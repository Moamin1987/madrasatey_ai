// ملف JavaScript خاص بمادة islamic - grade2 - term2
  ...
  const lessons = [
    {
      ...
      type: 'pdf',
      url: 'https://example.com/grade2/term2/islamic/lesson1.pdf'
    },
    {
      title: 'الدرس الثاني',
      description: 'الأجزاء الأساسية',
      type: 'text',
      url: 'https://example.com/grade2/term2/islamic/lesson2.txt'
    },
    {
      title: 'الدرس الثالث',
      description: 'تطبيقات عملية',
      type: 'pdf',
      url: 'https://example.com/grade2/term2/islamic/lesson3.pdf'
    }
  ];
  container.innerHTML='';
  ...
  const games = [
    {
      ...
      type: 'html',
      url: 'https://example.com/grade2/term2/islamic/game1.html'
    },
    {
      title: 'لعبة التطبيق',
      description: 'تطبيق عملي للمفاهيم',
      type: 'html',
      url: 'https://example.com/grade2/term2/islamic/game2.html'
    }
  ];
  container.innerHTML='';
